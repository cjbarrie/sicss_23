...
4.  Investigate the [conText](https://github.com/prodriguezsosa/conText/) package and implement an analysis with e.g., the `nns_ratio()` function or another function. See [this guide](https://cran.r-project.org/web/packages/conText/vignettes/quickstart.html) for some example analyses.
